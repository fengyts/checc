...
public class UserController extends BaseController {
	...
	public void qrcode(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap) {
		try {
			...
			BitMatrix bitMatrix;
			try {
				bitMatrix = new MultiFormatWriter().encode(text, BarcodeFormat.QR_CODE, width,
						height, hints);
	...
	public Map<String, Object> hadPay(UserVO user, HttpServletRequest request,
