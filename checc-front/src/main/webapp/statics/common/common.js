/**
 * 产品名称: Ecshop生鲜蔬菜商城模板 使用版本：Ecshop v2.7.3版 出品单位: O菜龙工作室出品
 * 设计者网址：http://www.ocailong.com/ 设计者QQ：763191200（o菜龙）
 */
...
function openSpeDiv1(message, goods_id, parent) {
	...
	newDiv.innerHTML += "<br /><center>[<a href='javascript:submit_div1("
			+ goods_id
			+ ","
			+ parent
			+ ")' class='f6' >"
