	...
	$(".uc_help_i").on('mouseover', function() {
		...
		if(0 == _index){
			_ct = "<font style='font-size:14px;'><b>竞拍账户：</b></font></br>"
				  ...
				  + "2、当您参与某台车的竞拍最终流拍时，您在该台车竞拍所出价的西币会全部退回至本账户，可以用来继续参与其它车辆的竞拍。</br>"
				  + "3、本账户的西币只能用来参与竞拍，不能兑换礼品、提现或兑换现金。";
		}else {
			_ct = "<font style='font-size:14px;'><b>兑换账户：</b></font></br>"
					+ "1、当您参与某台车的竞拍最终由其他用户拍得时，您在该台车竞拍所出价的西币会全部退回至本账户。</br>"
					+ "2、当您参与某台车的竞拍最终由您本人拍得时，你在该台车竞拍所出价的全部西币均不予退回。</br>"
