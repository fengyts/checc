...
<body>
	...
	<div class="hp_content">
		...
		<div class="hp_content_c">
			...
			<p>
				车西西官方为广大用户提供了多种福利，请用微信扫描网站右上角二维码，关注车西西官方微信，即可了解详细的福利信息。
			</p>
			...
			<p>
				...
				举例：某台车当前竞拍价为1000元，当前领先的用户为小明，此时您出价1个西币，则这台车新的当前竞拍价为1001元，小明出局，您领先。
			</p>
			...
			<p>	
				当您成功拍得某台车后，自拍得之日起<strong><span class="declar">60</span></strong>天内，你需要再支付等同于最终竞拍价的价格即可买下这台车，价格可能非常低噢。</br>
				无论您在哪个城市，车西西会安排您到当地就近的汽车经销商处完成该台车的购买手续（可申请按揭贷款，具体审批以最终结果为准），并且以后将由该经销商为您提供售后等相关服务。</br>
			...
			<p>
				...
				<span class="inhent_all">2.1是其它人所拍得，那么您参与该台车竞拍所出价的西币会全部退回到兑换账户里，并且只能用来兑换礼品，不能参与竞拍、提现或兑换现金。您可以在 <strong><span class="declar_lk"><a href="${domain}/user/bis/membercenter">个人中心-->兑换账户</a></span></strong> 里查看。</span></br>
				<span class="inhent_all">2.2是您所拍得，那么您参与该台车竞拍所出价的全部西币均不予退回。</span>
			</p>
			...
			<p>	
				车西西网站只支持手机号注册，注册时，先填写您的手机号，然后获取短信验证码，再设置登录密码，最后填写图片验证码，点击注册按钮即可。</br>
				同一个手机号只能注册一次。</br>
