...
<#macro outPutPageNo pagination url formId showPageLinkCount isShowMoreLI >
	...
	.mypager li.pageTo input.formButton {width: 40px; background: #F3F3F3;  height: 20px; cursor: pointer;}
	.mypager li.pageTo input.formButton:hover {background: #ff9900; color: #ffffff; cursor: pointer;}
	</style>
</#macro>